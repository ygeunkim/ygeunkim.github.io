...
#>         y1   y2   y3   y4
#>  [1,] 19.8 21.8 8.96 27.8
#>  [2,] 19.4 19.4 8.04 25.6
#>  [3,] 19.1 18.1 7.52 24.7
#>  [4,] 18.8 17.2 7.20 24.2
#>  [5,] 18.7 16.7 6.99 23.9
#>  [6,] 18.6 16.3 6.85 23.8
#>  [7,] 18.5 16.0 6.77 23.7
...
#>         y1   y2    y3   y4
#>  [1,] 20.3 21.5  11.4 28.0
#>  [2,] 20.6 19.3  12.4 25.7
#>  [3,] 21.0 18.5  13.8 24.8
#>  [4,] 21.5 18.4  15.5 24.6
#>  [5,] 22.1 18.5  17.7 24.5
#>  [6,] 22.9 18.8  20.5 24.6
#>  [7,] 23.8 19.4  23.9 24.8
#>  [8,] 24.9 20.1  28.3 25.1
#>  [9,] 26.1 21.1  33.7 25.4
#> [10,] 27.7 22.3  40.5 25.8
#> [11,] 29.5 23.9  48.9 26.4
#> [12,] 31.6 25.8  59.6 27.0
#> [13,] 34.1 28.3  72.9 27.9
#> [14,] 37.0 31.3  89.5 28.9
#> [15,] 40.4 35.1 110.4 30.3
#> [16,] 44.4 39.8 136.5 31.9
#> [17,] 49.0 45.7 169.3 34.0
#> [18,] 54.3 53.0 210.2 36.5
#> [19,] 60.3 62.1 261.6 39.7
#> [20,] 67.2 73.5 325.9 43.7
```
...
#>         y1   y2   y3   y4
#>  [1,] 19.5 20.3 8.13 26.1
#>  [2,] 19.0 17.9 7.33 24.5
#>  [3,] 18.8 17.0 7.06 24.1
#>  [4,] 18.7 16.6 6.94 23.9
#>  [5,] 18.6 16.4 6.86 23.8
#>  [6,] 18.5 16.1 6.79 23.7
#>  [7,] 18.5 16.0 6.75 23.6
#>  [8,] 18.5 15.9 6.73 23.6
...
#>  1.000  0.966  4.595 35.828  4.682
```
...
list(
  ...
  unlist()
#>      VAR     VHAR     BVAR   BVHAR1   BVHAR2 
#> 1.00e+00 9.87e-01 2.41e+04 5.58e+02 2.06e+03
```
...
list(
  ...
  unlist()
#>      VAR     VHAR     BVAR   BVHAR1   BVHAR2 
#>     1.00     0.98 28408.79 10393.67 55056.44
```
